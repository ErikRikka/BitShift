        ...
        <Grid DockPanel.Dock="Bottom" Margin="0,0,0,8" HorizontalAlignment="Left">
          <Border x:Name="BtnGear" Background="Transparent" CornerRadius="8" Padding="5" Cursor="Hand"
            ...
            <Grid Width="18" Height="18">
              <Path x:Name="GearTeeth" Fill="{StaticResource Tx2}" Data="F0 M15.1,9.75 L17.43,10.71 L16.17,13.75 L13.85,12.78 L12.78,13.85 L13.75,16.17 L10.71,17.43 L9.75,15.1 L8.25,15.1 L7.29,17.43 L4.25,16.17 L5.22,13.85 L4.15,12.78 L1.83,13.75 L0.57,10.71 L2.9,9.75 L2.9,8.25 L0.57,7.29 L1.83,4.25 L4.15,5.22 L5.22,4.15 L4.25,1.83 L7.29,0.57 L8.25,2.9 L9.75,2.9 L10.71,0.57 L13.75,1.83 L12.78,4.15 L13.85,5.22 L16.17,4.25 L17.43,7.29 L15.1,8.25 Z M6.05,9 A2.95,2.95 0 1 0 11.95,9 A2.95,2.95 0 1 0 6.05,9 Z"/>
            </Grid>
          </Border>
